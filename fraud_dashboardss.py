...
if page == "Overview":
    ...
    col1.image(r"confusion_matrix.jpg", caption="Confusion Matrix", use_container_width=True)
    col2.image(r"roc_curve.jpg", caption="ROC Curve", use_container_width=True)
    col3.image(r"precision_recall_curve.jpg", caption="Precision–Recall Curve", use_container_width=True)
...
# --------------------------------------------
    ...
    col1.image(r"shap_bar_plot.jpg", caption="Mean SHAP Importance", use_container_width=True)
    col2.image(r"shap_summary_plot.jpg", caption="SHAP Summary (Beeswarm)", use_container_width=True)
